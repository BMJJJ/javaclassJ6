  ...
  <table class="table table-hover text-center">
    ...
    <c:forEach var="replyVo" items="${replyVos}" varStatus="st">
      <tr>
        ...
        <td class="text-left">
          <c:if test="${replyVo.openSw == 'NO' && !(sMid == replyVo.mid || sLevel == 0)}">
            <i>비밀 댓글입니다.</i>
          </c:if>
          <c:if test="${replyVo.openSw == 'OK' || (replyVo.openSw == 'NO' && (sMid == replyVo.mid || sLevel == 0))}">
    ...
    <table class="table table-center">
      <tr>
        <td style="width:85%" class="text-left">
          글내용 :
          <textarea rows="4" name="content" id="content" class="form-control" placeholder="본인이 쓴 글에 대한 책임은 본인한테 있습니다."></textarea>
        </td>
        <td style="width:15%">
          <br/>
          <p>작성자 : ${sNickName}</p>
